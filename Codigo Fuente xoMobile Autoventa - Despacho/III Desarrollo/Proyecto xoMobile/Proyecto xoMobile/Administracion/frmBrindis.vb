...
Public Class frmBrindis
    ...
    Dim ldoc As New Factura
    Dim ndoc As New NotaCreditoDT
    ...
    Private Sub frmBrindis_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Select Case id_glo_sociedad
            Case 4000
                Label1.Text = "DISTRIBUIDORA DE LICORES.S. A.                    "
            Case 7000
                Label1.Text = "LEVADURAS UNIVERSAL S. A.                    "
            Case Else
                Label1.Text = "NO TIENE SOCIEDAD SELECCIONADA                 "
        End Select
    ...
    Private Sub cmdIniciar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdIniciar.Click
        ...
        'ldoc.anularDocumentosSin()
        'ndoc.anularDocumentosSin()
...
#End Region
    ...
    Private Sub LinkLabel1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles LinkLabel1.Click
        '--- Datos del Release
        Dim msg = id_glo_sistema + id_glo_version + vbCrLf + "Industrias Licoreras de Guatemala"
    ...
    Private Sub frmBrindis_KeyDown(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
